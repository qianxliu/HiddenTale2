...
import com.qianxin.hiddentale.utils.CheckNetwork
import com.qianxin.hiddentale.utils.PermissionHandler
    ...
    inner class ViewPagerAdapter : PagerAdapter() {
        ...
        override fun instantiateItem(container: ViewGroup, position: Int): Any {
            ...
            Glide.with(this@ViewBigImageActivity).load(imageUrl)
                    ...
                    .listener(object : RequestListener<Drawable> { //监听图片加载是否完成
