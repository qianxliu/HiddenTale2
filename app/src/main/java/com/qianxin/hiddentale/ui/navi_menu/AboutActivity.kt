...
import com.qianxin.hiddentale.utils.BaseTools
import com.qianxin.hiddentale.utils.PerfectClickListener
...
class AboutActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 直接写在布局文件里会很耗内存
        Glide.with(this).load(R.drawable.ic_hiddentale).into(iv_icon)
