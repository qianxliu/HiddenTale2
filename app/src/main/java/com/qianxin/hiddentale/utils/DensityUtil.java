...
public class DensityUtil {
    ...
    public static int dip2px(float dpValue) {
        final float scale = App.instrance.getResources().getDisplayMetrics().density;
    ...
    public static void formatHeight(View imageView, float bili, int type, int marginLR, int marginTop, int marginBottom) {
        WindowManager wm = (WindowManager) App.instrance.getSystemService(Context.WINDOW_SERVICE);
